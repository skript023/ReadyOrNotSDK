...
#include "AG_HasValidZone_classes.hpp"
#include "AG_HasValidZone_parameters.hpp"
...
bool UAG_HasValidZone_C::CanOpen(const struct FAIActionDecisionContext& Context) const
{
	...
	Params::AG_HasValidZone_C_CanOpen Parms{};
