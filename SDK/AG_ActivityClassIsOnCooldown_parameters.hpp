...
public:
	...
	class UActivityManager*                       CallFunc_GetWorldSubsystem_ReturnValue;            // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_AG_ActivityClassIsOnCooldown_C_CanOpen;
