...
struct BP_Sound_PlayVO_Notify_C_Received_Notify final
{
public:
	...
	bool                                          CallFunc_PlayRawVO_ReturnValue;                    // 0x0069(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_Sound_PlayVO_Notify_C_Received_Notify;
