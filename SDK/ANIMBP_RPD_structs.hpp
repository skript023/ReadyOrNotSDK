...
struct ANIMBP_RPD::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
...
DUMPER7_ASSERTS_ANIMBP_RPD__FAnimBlueprintGeneratedConstantData;

// ScriptStruct ANIMBP_RPD.ANIMBP_RPD_C.AnimBlueprintGeneratedMutableData
// 0x0001 (0x0002 - 0x0001)
struct ANIMBP_RPD::FAnimBlueprintGeneratedMutableData final : public FAnimBlueprintMutableData
{
public:
	bool                                          __BoolProperty;                                    // 0x0001(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_ANIMBP_RPD__FAnimBlueprintGeneratedMutableData;
