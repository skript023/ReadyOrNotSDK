...
#include "AC_TargetStunRemainingTime_classes.hpp"
#include "AC_TargetStunRemainingTime_parameters.hpp"
...
float UAC_TargetStunRemainingTime_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess) const
{
	...
	Params::AC_TargetStunRemainingTime_C_Score Parms{};
