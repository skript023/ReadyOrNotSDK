...
#include "AG_HasCombatMove_classes.hpp"
#include "AG_HasCombatMove_parameters.hpp"
...
bool UAG_HasCombatMove_C::CanOpen(const struct FAIActionDecisionContext& Context) const
{
	...
	Params::AG_HasCombatMove_C_CanOpen Parms{};
