...
void UW_PreMission_Tablet_Legend_C::ExecuteUbergraph_W_PreMission_Tablet_Legend(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
...
void UW_PreMission_Tablet_Legend_C::Toggle(bool* IsOpen_0)
{
	static class UFunction* Func = nullptr;
