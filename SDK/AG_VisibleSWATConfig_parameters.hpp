...
struct AG_VisibleSWATConfig_C_CanOpen final
{
public:
	...
	float                                         CallFunc_GetVisibleSWATPercentage_ReturnValue;     // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_AG_VisibleSWATConfig_C_CanOpen;
