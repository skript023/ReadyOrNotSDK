...
struct AC_RecentSWATDeath_C_Score final
{
public:
	...
	float                                         CallFunc_GetTimeSinceLastSWATDeath_ReturnValue;    // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_AC_RecentSWATDeath_C_Score;
