...
#include "AG_SquadmateCount_classes.hpp"
#include "AG_SquadmateCount_parameters.hpp"
...
bool UAG_SquadmateCount_C::CanOpen(const struct FAIActionDecisionContext& Context) const
{
	...
	Params::AG_SquadmateCount_C_CanOpen Parms{};
