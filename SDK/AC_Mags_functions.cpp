...
#include "AC_Mags_classes.hpp"
#include "AC_Mags_parameters.hpp"
...
float UAC_Mags_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess) const
{
