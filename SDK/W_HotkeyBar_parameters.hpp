...
public:
	...
	TDelegate<void(class UW_HotkeyBar_Entry_C* TriggeringHotkeyEntry)> K2Node_CreateDelegate_OutputDelegate; // 0x0018(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UW_HotkeyBar_Entry_C*                   K2Node_CustomEvent_TriggeringHotkeyEntry;          // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UW_HotkeyBar_Entry_C*                   CallFunc_Create_ReturnValue;                       // 0x00C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UW_HotkeyBar_Entry_C*                   CallFunc_Array_Get_Item_1;                         // 0x00E0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_W_HotkeyBar_C_ExecuteUbergraph_W_HotkeyBar;
...
{
public:
	class UW_HotkeyBar_Entry_C*                   TriggeringHotkeyEntry;                             // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_W_HotkeyBar_C_HotkeyButtonClicked;
...
DUMPER7_ASSERTS_W_HotkeyBar_C_PreConstruct;
...
{
public:
	TArray<struct Fst_HotkeySettings>             Hotkeys_0;                                         // 0x0000(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
DUMPER7_ASSERTS_W_HotkeyBar_C_UpdateHints;
