...
#include "W_InputActionButton_classes.hpp"
#include "W_InputActionButton_parameters.hpp"
...
void UW_InputActionButton_C::DisableInteraction(bool Disable)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_DisableInteraction Parms{};
...
void UW_InputActionButton_C::Enable(bool Enable_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_Enable Parms{};
...
void UW_InputActionButton_C::EventOnPressed(class UCommonButtonBase* Button)
{
	...
	Params::W_InputActionButton_C_EventOnPressed Parms{};
...
void UW_InputActionButton_C::EventOnReleased(class UCommonButtonBase* Button)
{
	...
	Params::W_InputActionButton_C_EventOnReleased Parms{};
...
void UW_InputActionButton_C::ExecuteUbergraph_W_InputActionButton(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_ExecuteUbergraph_W_InputActionButton Parms{};
...
void UW_InputActionButton_C::IgnoreInteraction(bool Ignore)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_IgnoreInteraction Parms{};
...
void UW_InputActionButton_C::InitContent()
{
	static class UFunction* Func = nullptr;
...
void UW_InputActionButton_C::InputChanged(ECommonInputType bNewInputType)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_InputChanged Parms{};
...
void UW_InputActionButton_C::OnActionProgress(float HeldPercent)
{
	...
	Params::W_InputActionButton_C_OnActionProgress Parms{};
...
struct FEventReply UW_InputActionButton_C::OnMouseButtonDown(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_OnMouseButtonDown Parms{};
...
struct FEventReply UW_InputActionButton_C::OnMouseButtonUp(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_OnMouseButtonUp Parms{};
...
void UW_InputActionButton_C::PassthroughInteraction(bool PassThrough)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_PassthroughInteraction Parms{};
...
void UW_InputActionButton_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::W_InputActionButton_C_PreConstruct Parms{};
...
void UW_InputActionButton_C::SetBackgroundTint(const struct FLinearColor& InBackgroundColor)
{
	...
	Params::W_InputActionButton_C_SetBackgroundTint Parms{};
...
void UW_InputActionButton_C::SetButtonText(const class FText& Text)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_SetButtonText Parms{};
...
void UW_InputActionButton_C::TruncateText(bool Truncate, int32 CharacterLimit_0, const class FString& TruncationCharacters)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_TruncateText Parms{};
...
class UCommonTextBlock* UW_InputActionButton_C::BP_GetButtonLabel() const
{
	static class UFunction* Func = nullptr;
	...
	Params::W_InputActionButton_C_BP_GetButtonLabel Parms{};
