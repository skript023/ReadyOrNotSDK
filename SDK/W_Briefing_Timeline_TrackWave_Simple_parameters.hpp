...
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_EventListener;
...
public:
	...
	class USoundWave*                             K2Node_CustomEvent_SoundWave;                      // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<double, struct FTimelineEvent>           K2Node_CustomEvent_EventEntries;                   // 0x0010(0x0050)()
	...
	class UW_Briefing_Timeline_TrackWaveElement_vert_C* CallFunc_Create_ReturnValue;                 // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class USoundWave*                             CallFunc_GetTimelineEventTestData_Audio_Asset;     // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<struct FTimelineEvent>                 CallFunc_GetTimelineEventTestData_Events;          // 0x00D0(0x0010)(ReferenceParm)
	TMap<double, struct FTimelineEvent>           CallFunc_GetTimelineEventTestData_EventEntries;    // 0x00E0(0x0050)()
	int32                                         CallFunc_Array_Add_ReturnValue;                    // 0x0130(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_ExecuteUbergraph_W_Briefing_Timeline_TrackWave_Simple;
...
public:
	...
	TMap<double, struct FTimelineEvent>           EventEntries_0;                                    // 0x0008(0x0050)(BlueprintVisible, BlueprintReadOnly, Parm)
};
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_Initialize;
...
public:
	...
	class UW_Briefing_Timeline_TrackWaveElement_vert_C* CallFunc_Array_Get_Item;                     // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_paused;
...
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_Playing;
...
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_PreConstruct;
...
DUMPER7_ASSERTS_W_Briefing_Timeline_TrackWave_Simple_C_Tick;
