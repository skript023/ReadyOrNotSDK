...
#include "W_Stats_Missions_Favorite_classes.hpp"
#include "W_Stats_Missions_Favorite_parameters.hpp"
...
void UW_Stats_Missions_Favorite_C::BackPage(bool* Handled)
{
	...
	Params::W_Stats_Missions_Favorite_C_BackPage Parms{};
...
void UW_Stats_Missions_Favorite_C::ChangePage(class FName PageName)
{
	...
	Params::W_Stats_Missions_Favorite_C_ChangePage Parms{};
...
void UW_Stats_Missions_Favorite_C::CompareWithFriend(const struct FFriend& Friend)
{
	...
	Params::W_Stats_Missions_Favorite_C_CompareWithFriend Parms{};
...
void UW_Stats_Missions_Favorite_C::ExecuteUbergraph_W_Stats_Missions_Favorite(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_Stats_Missions_Favorite_C_ExecuteUbergraph_W_Stats_Missions_Favorite Parms{};
...
// Parameters:
// const class FString&                    LevelProgressionTagPrefix                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
...
void UW_Stats_Missions_Favorite_C::GetLevelContent(const class FString& LevelProgressionTagPrefix, class FText* LevelName, TSoftObjectPtr<class UTexture2D>* LevelPicture)
{
	static class UFunction* Func = nullptr;
	...
	Params::W_Stats_Missions_Favorite_C_GetLevelContent Parms{};

	Parms.LevelProgressionTagPrefix = std::move(LevelProgressionTagPrefix);
...
void UW_Stats_Missions_Favorite_C::Hide(double Delay, bool Collapse)
{
	...
	Params::W_Stats_Missions_Favorite_C_Hide Parms{};
...
void UW_Stats_Missions_Favorite_C::OnStatChanged(const class FString& StatID)
{
	...
	Params::W_Stats_Missions_Favorite_C_OnStatChanged Parms{};
...
void UW_Stats_Missions_Favorite_C::Reveal(double Delay)
{
	...
	Params::W_Stats_Missions_Favorite_C_Reveal Parms{};
...
void UW_Stats_Missions_Favorite_C::SetInputMode(bool IsGamepad)
{
	...
	Params::W_Stats_Missions_Favorite_C_SetInputMode Parms{};
...
void UW_Stats_Missions_Favorite_C::UpdateStats()
{
	static class UFunction* Func = nullptr;
...
void UW_Stats_Missions_Favorite_C::GetFocusTarget(class UWidget** Focus) const
{
	static class UFunction* Func = nullptr;
	...
	Params::W_Stats_Missions_Favorite_C_GetFocusTarget Parms{};
