...
// const class FText&                      LabelText                                              (Parm, NativeAccessSpecifierPublic)
// bool                                    DefaultSelection_0                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonCarousel::AddOption(class FName OptionNameID, const class FText& LabelText, bool DefaultSelection_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DefaultSelection_0 = DefaultSelection_0;
...
void UCommonCarousel::SetOptionLabelTextByID(class FName OptionNameID, const class FText& NewLabelText)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const TMap<class FName, class FText>&   NewOptions                                             (Parm, NativeAccessSpecifierPublic)
...
class FName UCommonCarousel::GetOptionAtIndex(int32 Index_0) const
{
	static class UFunction* Func = nullptr;
