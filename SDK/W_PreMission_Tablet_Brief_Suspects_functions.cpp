...
#include "W_PreMission_Tablet_Brief_Suspects_classes.hpp"
#include "W_PreMission_Tablet_Brief_Suspects_parameters.hpp"
...
struct FEventReply UW_PreMission_Tablet_Brief_Suspects_C::OnAnalogValueChanged(const struct FGeometry& MyGeometry, const struct FAnalogInputEvent& InAnalogInputEvent)
{
	...
	Params::W_PreMission_Tablet_Brief_Suspects_C_OnAnalogValueChanged Parms{};
...
void UW_PreMission_Tablet_Brief_Suspects_C::PopulateSuspects()
{
	static class UFunction* Func = nullptr;
...
class UWidget* UW_PreMission_Tablet_Brief_Suspects_C::BP_GetDesiredFocusTarget() const
{
	static class UFunction* Func = nullptr;
	...
	Params::W_PreMission_Tablet_Brief_Suspects_C_BP_GetDesiredFocusTarget Parms{};
