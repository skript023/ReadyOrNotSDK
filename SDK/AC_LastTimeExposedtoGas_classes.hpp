...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("AC_LastTimeExposedtoGas_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"AC_LastTimeExposedtoGas_C")
	}
	static class UAC_LastTimeExposedtoGas_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAC_LastTimeExposedtoGas_C>();
	}
};
DUMPER7_ASSERTS_UAC_LastTimeExposedtoGas_C;
